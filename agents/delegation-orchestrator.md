...
- Command: `${CLAUDE_PROJECT_DIR}/scripts/render_dependency_graph.sh`
...
**Note:** The ASCII dependency graph visualization is rendered by `scripts/render_dependency_graph.sh`, not generated by the LLM. After writing TodoWrite entries, invoke the script via Bash: `${CLAUDE_PROJECT_DIR}/scripts/render_dependency_graph.sh`
...
**Note:** The visual wave structure is rendered by `scripts/render_dependency_graph.sh`. After writing TodoWrite entries, invoke the script via Bash: `${CLAUDE_PROJECT_DIR}/scripts/render_dependency_graph.sh`
...
- After writing to TodoWrite, invoke: `${CLAUDE_PROJECT_DIR}/scripts/render_dependency_graph.sh` to render the ASCII dependency graph
