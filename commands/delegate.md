...
- For parallel waves (`parallel_execution: true`): spawn in batches of **MAX 4 concurrent**
  - If wave has >4 phases: spawn first 4, wait for completion, spawn next 4, repeat
